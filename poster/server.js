...
const SESSIONS = [];//storage for saving sessions

//storge for saving USERS
const USERS = [
  { id: 1, name: "name1", username: "user_1", password: "string" },
  { id: 2, name: "name2", username: "user_2", password: "string" },
  { id: 3, name: "name3", username: "user_3", password: "string" },
];

//storage for saving POSTS
const POSTS = [
  {
    id: 1,
...
//   id: 1,
//   title: "This is a post title",
//   body: "orem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the"
//   userId: 1,
// },
